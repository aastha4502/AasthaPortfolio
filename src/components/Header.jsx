    ...
    <header id="home" className="bg-gradient-to-br from-slate-900 to-slate-700 text-white">
      <div className="section text-center">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          <a href="https://www.linkedin.com/in/aasthagoyal1122/" target="_blank" rel="noreferrer" className="btn-primary">LinkedIn</a>
          <a href="https://github.com/aasthagoyal1122" target="_blank" rel="noreferrer" className="btn-outline">GitHub</a>
